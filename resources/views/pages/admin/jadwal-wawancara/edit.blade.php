...
@section('content')
    <div class="container-fluid p-4 p-md-5">
        ...
        <div class="card shadow">
            <form action="{{ route('jadwal-wawancara.update', $item->id) }}" method="post">
                @method('PUT')
                @csrf
                    <div class="card-header bg-body-tertiary py-3">
                    <h6 class="m-0">Edit Data Alur</h6>
                </div>
                <div class="card-body">
                    @error('title')
                    ...
                    <div class="row g-3">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            >
                                <option selected value="{{ $item->waktu_mulai }}">{{ $item->waktu_mulai }}</option>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select
                                ...
                                aria-label="Default select example"
                            >
                                <option selected value="{{ $item->waktu_akhir }}">{{ $item->waktu_akhir }}</option>
                                <option value="08.00 WITA">08.00 WITA</option>
                                <option value="08.30 WITA">08.30 WITA</option>
                                <option value="09.00 WITA">09.00 WITA</option>
                                <option value="09.30 WITA">09.30 WITA</option>
