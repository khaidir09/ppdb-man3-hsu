...
@section('content')
    <div class="container-fluid p-4 p-md-5">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ route('jadwal-wawancara.create') }}" class="btn tombol mt-3 mt-md-0"
                ><svg
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group" role="group">
                                            ...
                                            title="Edit Data"
                                            href="{{ route('jadwal-wawancara.edit', $item->id) }}"
                                            ...
                                            <form action="{{ route('jadwal-wawancara.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah anda yakin untuk menghapus data ini?')" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
