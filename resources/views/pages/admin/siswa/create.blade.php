                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="form-group col-md-6 col-lg-4">
                            ...
                            <input type="date" class="form-control" id="tgl_mulai_gelombang2" name="tgl_mulai_gelombang2" />
                        </div>
                        <div class="form-group col-md-6 col-lg-4">
                            <label for="tgl_selesai_gelombang2" class="form-label">Tanggal Selesai Gelombang 2</label>
                            <input type="date" class="form-control" id="tgl_selesai_gelombang2" name="tgl_selesai_gelombang2" />
                        </div>
                    </div>
                </div>
