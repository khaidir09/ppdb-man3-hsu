...
use App\Http\Controllers\Admin\HasilWawancaraController;
...
use App\Http\Controllers\Admin\SesiWawancaraController;
...
Route::prefix('admin')->middleware(['auth', 'verified', EnsureRole::class])->group(function () {
    ...
    Route::resource('wawancara', JadwalWawancaraController::class);
    Route::post('/wawancara', [JadwalWawancaraController::class, 'addResult'])->name('hasil-wawancara-siswa');
    ...
    Route::get('/hasil-wawancara/cetak', [HasilWawancaraController::class, 'cetak'])->name('cetak-hasil-wawancara');
